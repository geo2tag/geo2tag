...
TEST_CHANNELS = [
    ObjectId("556721a52a2e7febd2744201")]
TEST_NUMBER = 100
...
class TestFindpoints(unittest.TestCase):
    ...
    def testDateSearch(self):
        TEST_DATE_FROM = dateutil.parser.parse("900")
        TEST_DATE_FROM = dateutil.parser.parse("0")
        TEST_DATE_TO = dateutil.parser.parse("2000")
        TEST_DATE_TO_1 = dateutil.parser.parse("2000")
