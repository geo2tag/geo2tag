...
class Test_GT_1509_class_open_data_to_points_loader(TestCase):
    def test_GT_1509_class_open_data_to_points_loader(self):
    	...
    	self.assertEquals(None, collection.find_one({ID: ObjectId("552833515c0dd1178d37f7ee")}))
    	self.assertEquals(None, collection.find_one({ID: ObjectId("552833515c0dd1178d37f7ff")}))