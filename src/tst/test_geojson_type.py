...
BAD_TEST_POLYGON = [
    '{"coordintes": [[[2.3, 57.32], [23.19, -20.2], [-120.4, 19.1]]], "type": "Polygon"}',
...
TEST_MULTI_POLYGON_RESULT = {"coordinates": [[[[3.7, 9.2], [-130.9, 1.5], [35.1, 72.23]]], [
    [[23.1, -34.2], [-1.3, -4.6], [3.4, 77.9]]]], "type": "MultiPolygon"}
BAD_TEST_MULTI_POLYGON = [
    '{"coordinates": [[[[3.7, 9.2], [-130.9, 1.5], [35.1, 72.23]]], [[[23.1, -34.2], [-1.3, -4.6], [3.4, 77.9]]]], "type": "MultiPolygo"}',
