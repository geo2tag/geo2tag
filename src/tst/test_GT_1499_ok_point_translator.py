...
TEST_OBJ = {'json': {'import_source': 'test_import', 'version': 'test_version', 
			'image_url': 'image_url', 'name': 'test_GT_1499', 'source_url': 'object_url'}, 
			'channelId': 'channelId', 'location': {'type': 'Point', 'coordinates': [1, 2]}, 'alt': 0}

class TestOKPointTranslator(TestCase):
    def testOKPointTranslator(self):
        obj = OpenKareliaObjectToPointTranslator('image_url', 'object_url', {'name': ['test_GT_1499'], 'latitude': 1, 'longitude': 2}, 
