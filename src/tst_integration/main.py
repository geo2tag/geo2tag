...
from test_GT_1486_AfterRequesWriteInstanceLog \
    import TestAfterRequestWriteInstanceLog
...
from test_GT_1484_AfterRequestsStatusLogging \
    import TestAfterRequestStatusLogging
